package com.yjt.app.permission;
...
/**
 * This abstract class should be used to create an if/else action that the PermissionUtil
...
public abstract class PermissionsResultAction {
    ...
    @SuppressWarnings("WeakerAccess")
    @CallSuper
    public synchronized final boolean onResult(final @NonNull String permission, PermissionStatus result) {
