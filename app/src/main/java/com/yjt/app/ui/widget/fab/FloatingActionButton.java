...
public class FloatingActionButton extends ImageButton {
    ...
    void init(Context context, AttributeSet attributeSet) {
        ...
        updateCircleSize();
        mShadowRadius = getDimension(R.dimen.dp_9);
        mShadowOffset = getDimension(R.dimen.dp_3);
        updateDrawableSize();
    ...
    private void updateCircleSize() {
        mCircleSize = getDimension(mSize == SIZE_NORMAL ? R.dimen.dp_56 : R.dimen.dp_40);
    }
    ...
    void updateBackground() {
        final float strokeWidth = getDimension(R.dimen.dp_1);
        final float halfStrokeWidth = strokeWidth / 2f;

        LayerDrawable layerDrawable = new LayerDrawable(
                new Drawable[]{
                        getResources().getDrawable(mSize == SIZE_NORMAL ? R.mipmap.icon_fab1 : R.mipmap.icon_fab2),
                        createFillDrawable(strokeWidth),
                        createOuterStrokeDrawable(strokeWidth),
                        getIconDrawable()
                });

        int iconOffset = (int) (mCircleSize - getDimension(R.dimen.dp_24)) / 2;
