package com.yjt.app.ui.widget.fab;
...
public class FloatingActionMenu extends ViewGroup {
    ...
    private OnFloatingActionMenuUpdateListener mListener;
    ...
    private void init(Context context, AttributeSet attributeSet) {
        mButtonSpacing = (int) (getResources().getDimension(R.dimen.dp_16) - getResources().getDimension(R.dimen.dp_9) - getResources().getDimension(R.dimen.dp_3));
        mLabelsMargin = getResources().getDimensionPixelSize(R.dimen.dp_8);
        mLabelsVerticalOffset = getResources().getDimensionPixelSize(R.dimen.dp_3);
        ...
        mAddButtonSize = attr.getInt(R.styleable.FloatingActionMenu_fab_addButtonSize, FloatingActionButton.SIZE_NORMAL);
        mAddButtonStrokeVisible = attr.getBoolean(R.styleable.FloatingActionMenu_fab_addButtonStrokeVisible, true);
        ...
        mLabelsPosition = attr.getInt(R.styleable.FloatingActionMenu_fab_labelsPosition, LABELS_ON_LEFT_SIDE);
        attr.recycle();
