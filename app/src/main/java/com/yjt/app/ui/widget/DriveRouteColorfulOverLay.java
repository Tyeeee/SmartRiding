...
public class DriveRouteColorfulOverLay {
    ...
    public DriveRouteColorfulOverLay(AMap amap, DrivePath path,
        ...
        mAMap = amap;
        drivePath = path;
        startPoint = MapUtil.getInstance().convertToLatLng(start);
        endPoint = MapUtil.getInstance().convertToLatLng(end);
    ...
    private BitmapDescriptor getThroughPointBitDes() {
        return BitmapDescriptorFactory.fromResource(R.mipmap.icon_pass);
